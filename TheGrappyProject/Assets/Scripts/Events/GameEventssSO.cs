...
public class GameEventssSO : ScriptableObject
{
    ...
    public event UnityAction onPlayerRespawnTap;
    public event UnityAction onMapLoaded;
    public event UnityAction<Ability> onChangedAbility;
    public event UnityAction<Ability> onUsedAbility;
    ...
    public void OnPlayerRespawnTap()
    {
        onPlayerRespawnTap?.Invoke();
    }
    ...
    public void OnUsedAbility(Ability ability)
    {
        onUsedAbility?.Invoke(ability);
    }
